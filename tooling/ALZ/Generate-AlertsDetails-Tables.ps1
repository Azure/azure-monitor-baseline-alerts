...
"hidden: true" | Out-File $activityLogAlertTableFile -Encoding utf8NoBOM -Append
...
"hidden: true" | Out-File $LogSearchAlertTableFile -Encoding utf8NoBOM -Append
...
"hidden: true" | Out-File $metricAlertTableFile -Encoding utf8NoBOM -Append

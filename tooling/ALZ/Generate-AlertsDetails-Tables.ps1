...
"hidden: true" | Out-File $activityLogAlertTableFile -Encoding UTF8 -Append
...
"hidden: true" | Out-File $LogSearchAlertTableFile -Encoding UTF8 -Append
...
"hidden: true" | Out-File $metricAlertTableFile -Encoding UTF8 -Append

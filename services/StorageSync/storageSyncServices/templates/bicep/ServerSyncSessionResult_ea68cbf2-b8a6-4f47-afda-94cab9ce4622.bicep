...
param alertDescription string = 'Metric that logs a value of 1 each time the Server Endpoint successfully completes a Sync Session with the Cloud Endpoint'
  ...
  properties: {
    ...
    criteria: {
      ...
      allOf: [
        {
          name: '1st criterion'
          metricName: 'ServerSyncSessionResult'
          dimensions: [[]]
          operator: operator
          threshold: threshold

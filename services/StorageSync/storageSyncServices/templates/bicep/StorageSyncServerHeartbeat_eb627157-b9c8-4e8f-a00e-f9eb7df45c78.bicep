...
param alertDescription string = 'Metric that logs a value of 1 each time the resigtered server successfully records a heartbeat with the Cloud Endpoint'
...
param evaluationFrequency string = 'PT30M'
  ...
  properties: {
    ...
    criteria: {
      ...
      allOf: [
        {
          name: '1st criterion'
          metricName: 'StorageSyncServerHeartbeat'
          dimensions: [[]]
          operator: operator
          threshold: threshold

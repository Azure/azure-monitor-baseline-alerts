...
param alertDescription string = 'The storage account will be throttled if throughput exceeds the account's tier limit. Increasing the file share or storage tier may be necessary.'
          ...
          dimensions: [
            {
              name: 'ResponseType'
              operator: 'Include'
              values: ['SuccessWithThrottling SuccessWithShareIopsThrottling ClientShareIopsThrottlingError']
            }
            {
              name: 'FileShare'
              operator: 'Include'

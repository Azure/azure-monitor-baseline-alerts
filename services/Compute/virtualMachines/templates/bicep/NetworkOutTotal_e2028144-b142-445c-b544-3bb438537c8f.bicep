...
param alertDescription string = 'The number of bytes out on all network interfaces by the Virtual Machine(s) (Outgoing Traffic)'
...
param threshold int = 200000000000

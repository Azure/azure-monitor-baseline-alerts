...
>
> When deploying at scale, we include all management groups and subscriptions under the pseudo root management group hierarchy. This might force the inclusion of unwanted resources. Should this be the case it is possible to exclude them after the deployment. To do so, it is necessary to:
>

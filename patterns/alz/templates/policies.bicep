...
var loadPolicyDefinitions = {
  All: [
    loadTextContent('../../../resources/Automation/automationAccounts/Deploy-AA-TotalJob-Alert.json')
    loadTextContent('../../../resources/Network/azureFirewalls/Deploy-ActivityLog-AzureFirewall-Del.json')
    loadTextContent('../../../resources/KeyVault/vaults/Deploy-ActivityLog-KeyVault-Del.json')
    loadTextContent('../../../resources/OperationalInsights/workspaces/Deploy-ActivityLog-LAWorkspace-Del.json')
    loadTextContent('../../../resources/OperationalInsights/workspaces/Deploy-ActivityLog-LAWorkspace-KeyRegen.json')
    loadTextContent('../../../resources/Network/networkSecurityGroups/Deploy-ActivityLog-NSG-Del.json')
    loadTextContent('../../../resources//Resources/subscriptions/Deploy-ActivityLog-ResourceHealth-UnHealthly-Alert.json')
    loadTextContent('../../../resources/Network/routeTables/Deploy-ActivityLog-RouteTable-Update.json')
    loadTextContent('../../../resources/Resources/subscriptions/Deploy-ActivityLog-ServiceHealth-Health.json')
    loadTextContent('../../../resources/Resources/subscriptions/Deploy-ActivityLog-ServiceHealth-Incident.json')
    loadTextContent('../../../resources/Resources/subscriptions/Deploy-ActivityLog-ServiceHealth-Maintenance.json')
    loadTextContent('../../../resources/Resources/subscriptions/Deploy-ActivityLog-ServiceHealth-Security.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-ActivityLog-VPNG-Del.json')
    loadTextContent('../../../resources/Network/azureFirewalls/Deploy-AFW-FirewallHealth-Alert.json')
    loadTextContent('../../../resources/Network/azureFirewalls/Deploy-AFW-SNATPortUtilization-Alert.json')
    loadTextContent('../../../resources/AlertsManagement/actionRules/Deploy-AlertProcessingRule-Deploy.json')
    loadTextContent('../../../resources/Network/expressRouteCircuits/Deploy-ERCIR-ARPAvailability-Alert.json')
    loadTextContent('../../../resources/Network/expressRouteCircuits/Deploy-ERCIR-BGPAvailability-Alert.json')
    loadTextContent('../../../resources/Network/expressRouteCircuits/Deploy-ERCIR-QOSDropsBitsIn-Alert.json')
    loadTextContent('../../../resources/Network/expressRouteCircuits/Deploy-ERCIR-QOSDropsBitsOut-Alert.json')
    loadTextContent('../../../resources/Network/expressRouteGateways/Deploy-ERG-BitsInPerSecond-Alert.json')
    loadTextContent('../../../resources/Network/expressRouteGateways/Deploy-ERG-BitsOutPerSecond-Alert.json')
    loadTextContent('../../../resources/Network/expressRouteGateways/Deploy-ERG-CPUUtilization-Alert.json')
    loadTextContent('../../../resources/KeyVault/vaults/Deploy-KV-Availability-Alert.json')
    loadTextContent('../../../resources/KeyVault/vaults/Deploy-KV-Capacity-Alert.json')
    loadTextContent('../../../resources/KeyVault/vaults/Deploy-KV-Latency-Alert.json')
    loadTextContent('../../../resources/KeyVault/vaults/Deploy-KV-Requests-Alert.json')
    loadTextContent('../../../resources/Network/privateDnsZones/Deploy-PDNSZ-CapacityUtilization-Alert.json')
    loadTextContent('../../../resources/Network/privateDnsZones/Deploy-PDNSZ-QueryVolume-Alert.json')
    loadTextContent('../../../resources/Network/privateDnsZones/Deploy-PDNSZ-RecordSetCapacity-Alert.json')
    loadTextContent('../../../resources/Network/privateDnsZones/Deploy-PDNSZ-RegistrationCapacityUtilization-Alert.json')
    loadTextContent('../../../resources/Network/publicIPAddresses/Deploy-PIP-BytesInDDOSAttack-Alert.json')
    loadTextContent('../../../resources/Network/publicIPAddresses/Deploy-PIP-DDOSAttack-Alert.json')
    loadTextContent('../../../resources/Network/publicIPAddresses/Deploy-PIP-PacketsInDDOS-Alert.json')
    loadTextContent('../../../resources/Network/publicIPAddresses/Deploy-PIP-VIPAvailability-Alert.json')
    loadTextContent('../../../resources/storage/storageAccounts/Deploy-SA-Availability-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-AvailableMemory-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-DataDiskReadLatency-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-DataDiskSpace-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-DataDiskWriteLatency-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-HeartBeat-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-HeartBeatAlertRG.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-NetworkIn-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-NetworkOut-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-OSDiskReadLatency-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-OSDiskSpace-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-OSDiskWriteLatency-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-PercentCPU-Alert.json')
    loadTextContent('../../../resources/Compute/virtualMachines/Deploy-VM-PercentMemory-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworks/Deploy-VNET-DDOSAttack-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-BandwidthUtilization-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-Egress-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-EgressPacketDropCount-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-EgressPacketDropMismatch-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-ERGBitsPerSecond-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-ERGCPUUtilization-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-Ingress-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-IngressPacketDropCount-Alert.json')
    loadTextContent('../../../resources/Network/virtualNetworkGateways/Deploy-VNETG-IngressPacketDropMismatch-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-BandwidthUtilization-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-BGPPeerStatus-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-Egress-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-EgressPacketDropCount-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-EgressPacketDropMismatch-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-Ingress-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-IngressPacketDropCount-Alert.json')
    loadTextContent('../../../resources/Network/vpnGateways/Deploy-VPNG-IngressPacketDropMismatch-Alert.json')
    loadTextContent('../../../resources/RecoveryServices/vaults/Modify-RSV-BackupHealth-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-ApplicationGatewayTotalTime-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-BackendLastByteResponseTime-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-CapacityUnits-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-ComputeUnits-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-CPUUtil-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-FailedRequests-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-ResponseStatus-Alert.json')
    loadTextContent('../../../resources/Network/applicationGateways/Deploy-AGW-UnhealthyHostCount-Alert.json')
    loadTextContent('../../../resources/Network/expressRoutePorts/Deploy-ERP-BitsInPerSecond-Alert.json')
    loadTextContent('../../../resources/Network/expressRoutePorts/Deploy-ERP-BitsOutPerSecond-Alert.json')
    loadTextContent('../../../resources/Network/expressRoutePorts/Deploy-ERP-LineProtocol-Alert.json')
    loadTextContent('../../../resources/Network/expressRoutePorts/Deploy-ERP-RxLightLevelHigh-Alert.json')
    loadTextContent('../../../resources/Network/expressRoutePorts/Deploy-ERP-RxLightLevelLow-Alert.json')
    loadTextContent('../../../resources/Network/expressRoutePorts/Deploy-ERP-TxLightLevelHigh-Alert.json')
    loadTextContent('../../../resources/Network/expressRoutePorts/Deploy-ERP-TxLightLevelLow-Alert.json')
    loadTextContent('../../../resources/Network/loadBalancers/Deploy-LB-DatapathAvailability-Alert.json')
    loadTextContent('../../../resources/Network/loadBalancers/Deploy-LB-GlobalBackendAvailability-Alert.json')
    loadTextContent('../../../resources/Network/loadBalancers/Deploy-LB-HealthProbeStatus-Alert.json')
    loadTextContent('../../../resources/Network/loadBalancers/Deploy-LB-UsedSNATPorts-Alert.json')
  ]
  AzureCloud: []
  AzureChinaCloud: []
  AzureUSGovernment: []

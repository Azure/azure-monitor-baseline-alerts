...
var loadPolicyDefinitions = {
  All: [
    ...
    loadTextContent('../../../services/KeyVault/vaults/Deploy-KV-SecretExpiry-Alert.json')
    loadTextContent('../../../services/KeyVault/vaults/Deploy-KV-CertificateExpiry-Alert.json')
    loadTextContent('../../../services/KeyVault/vaults/Deploy-KV-KeyExpiry-Alert.json')
